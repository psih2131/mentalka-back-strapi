...
export interface ApiPageReviewPageReview extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Reviews_banner_v1: Schema.Attribute.Component<'shared.banner-v1', false>;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    autor_name: Schema.Attribute.String & Schema.Attribute.Required;
    autor_photo: Schema.Attribute.Media<'images' | 'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReviewsCategoryReviewsCategory
  ...
  info: {
    displayName: 'reviews-categories';
  ...
  attributes: {
    ...
    category_logo: Schema.Attribute.Media<'images' | 'files'>;
